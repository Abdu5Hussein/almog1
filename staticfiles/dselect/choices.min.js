...
!(function (e, t) {
  ...
  class xe {
    constructor(
      ...
      if (
        ...
        return;
      const h = (e, t) => {
          this.chunks.push({ pattern: e, alphabet: Ie(e), startIndex: t });
        },
  ...
  (qe.version = "7.0.0"),
    ...
    (qe.parseIndex = function (
      e,
      { getFn: t = ye.getFn, fieldNormWeight: i = ye.fieldNormWeight } = {}
    ) {
          ...
          for (let n = 0, c = t.length; n < c; n += 1) {
            ...
            for (let t = 0, n = c.length; t < n; t += 1) {
              ...
              (s += 1),
                (r += l),
                i &&
                  (Fe.has(n.constructor.type) ? (o = [...o, ...h]) : o.push(h));
            }
            if (s) {
  ...
  var We = (function () {
      ...
      return (
        ...
        (e.prototype.search = function (e) {
          return (
            this._fuse ||
              (this._fuse = new qe(this._haystack, this._fuseOptions)),
        ...
        return (
          ...
          i &&
            ...
            s
              ...
              : r || Ge(this._docRoot, this.passedElement.element.id, a),
      ...
      input: function (e, t) {
        ...
        return (
          ...
          t
            ...
            : o || Ge(this._docRoot, this.passedElement.element.id, r),
          r
        );
      },
      dropdown: function (e) {
  ...
  return (function () {
    function e(t, n) {
      ...
      if (
        ...
        (this._baseId = (function (e) {
          var t =
            e.id || (e.name && "".concat(e.name, "-").concat(S(2))) || S(4);
          return (
            (t = t.replace(/(:|\.|\[|\]|,)/g, "")),
    ...
    return (
        ...
        return (
          ...
          this._store.withTxn(function () {
            ...
            e.forEach(function (e) {
              if ("choices" in e) {
                var o = e;
                c || (o = i(i({}, o), { label: o[n] })), r._addGroup(W(o, !0));
              } else {
                var a = e;
                (c && s) || (a = i(i({}, a), { value: a[t], label: a[n] })),
                  r._addChoice(W(a, !1));
              }
            }),
              r.unhighlightAll();
      ...
      (e.prototype._canCreateItem = function (e) {
        ...
        return (
          i && (n = x(t.addItemText, e)), n && this._displayNotice(n, ee), i
        );
      }),
      (e.prototype._searchChoices = function (e) {
        ...
        return (
          (s && s.type) !== ee &&
            (n.length
              ? this._clearNotice()
              : this._displayNotice(A(this.config.noResultsText), Z)),
              ...
              if (this._canAddItems()) {
                ...
                this._store.withTxn(function () {
                  if (!(r = i._findAndSelectChoiceByValue(n, !0))) {
                    ...
                    var e = w(n),
                      t =
                        i.config.allowHtmlUserInput || e === n
                          ? n
                          : { escaped: e, raw: n };
                    i._addChoice(
                      W({ value: t, label: t, selected: !0 }, !1),
                      !0,
                      !0
                    ),
                      (r = !0);
      ...
      (e.prototype._highlightChoice = function (e) {
        ...
        if (t.length) {
          ...
          Array.from(this.dropdown.element.querySelectorAll(k(n))).forEach(
            function (e) {
