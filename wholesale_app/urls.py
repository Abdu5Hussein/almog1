...
urlpatterns = [
    ...
    path('api/mainitem/create/test/', HozmaApi_views.create_mainitem_by_source_test, name='create_mainitem_by_source_test'),
    ...
    path('drivers/',views.Hozmadriver, name='Hozmadriver'),
     path('drivers/locations/',views.HozmaDriverlocations, name='Hozmadriver_locations'),
    ...
    path('api/employee/profile/', HozmaApi_views.employee_profile),
    path('delivery-history/', views.HozmaDriverHistory, name='HozmaDriverHistory'),
    ...
    #path('api/daily-report/', HozmaApi_views.daily_report, name='daily_report'),
    path('api/delivery-history/', HozmaApi_views.delivery_history, name='delivery-history'),
    path('api/client-summary/', HozmaApi_views.get_client_discount_and_delivery),
    path('api/employee/update-location/', HozmaApi_views.update_driver_location, name='update_driver_location'),
    path('api/delivery/confirm-delivery/<int:order_id>/', HozmaApi_views.confirm_delivery, name='confirm-delivery'),
    path('locations/', HozmaApi_views.get_employee_locations, name='employee-locations'),
