...
urlpatterns = [
    ...
    path("fetch-sell-invoice-items",fetch_sell_invoice_items,name="fetch-sell-invoice-items"),
    ...
    path('accept-order/<int:queue_id>/', accept_order, name='accept-order'),
    path('skip-order/<int:queue_id>/', skip_order, name='skip-order'),
    path('decline-order/<int:queue_id>/', decline_order, name='decline-order'),
