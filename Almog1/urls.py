...
urlpatterns = [
    ...
    path('mobile/logout', api_views.mobile_sign_out, name='mobile-mobile_sign_out'),
    ...
    path('api/filter-all-sources', api_views.filter_all_sources, name='filter-all-sources'),
    ...
    path('sources/report',views.sources_reports_View,name='sources_reports_View'),
    ...
    path('api/user/activate/toggle',api_views.toggle_user_active_status, name='toggle_user_active_status'),
    path('api/user/permissions/give-all-permissions/toggle', api_views.give_all_permissions, name='give_all_permissions'),
