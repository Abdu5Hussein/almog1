...
urlpatterns = [
    ...
    path('update-user/', views.UpdateUserView, name='update_user'),  # New URL for update
    ...
    path('api/filter-clients/', views.filter_clients, name='filter-clients'),
    path('api/filter-client-input/', views.filter_clients_input, name='filter-client-input'),
    path('update-itemvalue', mainitem_api_views.update_itemvalue, name='update-itemvalue'),
    path('fetch-lost-damaged-data/', views.fetch_lost_damaged_data, name='fetch_lost_damaged_data'),
    path('add-lost-damaged', views.add_lost_damaged, name='add_lost_damaged'),
    path('filter-lost-damaged', views.filter_lost_damaged, name='filter_lost_damaged'),
    path('api/delete-lost-damaged', views.delete_lost_damaged, name='delete_lost_damaged'),
    ...
    path('api/create-client', views.create_client_record, name='create-client'),
    path('api/update-client', views.update_client_record, name='update-client'),
    path('api/delete-client', views.delete_client_record, name='delete-client'),
    path('api/get-all-clients', views.get_all_clients, name='get-all-clients'),
    ...
    path('api/get-last-reciept-no', views.get_last_reciept_no, name='last-reciept-no'),
    ...
    path('get-last-buyinvoice-id',views.get_buyinvoice_no,name='get-last-buy-invoice'),
    path('api/create-buy-invoice-record',views.create_buy_invoice,name='create-buy-invoice'),
    path('add-invoice-items',views.BuyInvoiceItemsView,name='add-invoice-items'),
    path('api/create-invoice-item/', views.BuyInvoiceItemCreateView, name='create-invoice-item'),
    path("api/get-invoice-items",views.get_invoice_items,name="get_invoice_items"),
    path("manage-buy-invoice/",views.manage_buy_invoice,name="manage-buy-invoice"),
    path("fetch-buy-invoice-items",views.fetch_invoice_items,name="fetch-buy-invoice-items"),
    path("update-buyinvoiceitem",views.update_buyinvoiceitem,name="update-buy-invoice-item"),
    path("delete-buyinvoiceitem",views.delete_buy_invoice_item,name="delete-buy-invoice-item"),
    ...
    path("fetch-costs",views.fetch_costs,name="fetch-costs"),
    path('create-cost-record', views.create_cost_record, name='create-cost-record'),
    path('calculate-cost', views.calculate_cost, name='calculate-cost'),
    ...
    path("confirm_temp_invoice",views.confirm_temp_invoice,name="confirm_temp_invoice"),
    ...
    path('delete-buyinvoice-cost/<int:autoid>/', views.delete_buyinvoice_cost, name='delete_buyinvoice_cost'),
    path("b_invoice_management",views.Buyinvoice_management,name="b_invoice_management"),
    path('fetch-buyinvoices', views.fetch_buyinvoices, name='fetch_buyinvoices'),
    path('filter_buyinvoices', views.filter_buyinvoices, name='filter_buyinvoices'),
    ...
    path('api/create-sell-invoice-record', views.create_sell_invoice, name='create_sell_invoice'),
    path('get-last-sellinvoice-id',views.get_sellinvoice_no,name='get-last-sell-invoice'),
    path('sell_invoice_add_items',views.sell_invoice_add_items,name='sell_invoice_add_items'),
    path('sell_invoice_create_item',views.Sell_invoice_create_item,name='sell_invoice_create_item'),
    path("fetch-sell-invoice-items",views.fetch_sell_invoice_items,name="fetch-sell-invoice-items"),
    path('fetch-sellinvoices', views.fetch_sellinvoices, name='fetch_sellinvoices'),
    path('filter-sellinvoices', views.filter_sellinvoices, name='filter_sellinvoices'),
    ...
    path('prepare_sell_invoice', views.prepare_sell_invoice, name='prepare_sell_invoice'),
    path('validate_sell_invoice', views.validate_sell_invoice, name='validate_sell_invoice'),
    path('deliver_sell_invoice', views.deliver_sell_invoice, name='deliver_sell_invoice'),
    path('cancel_sell_invoice', views.cancel_sell_invoice, name='cancel_sell_invoice'),
